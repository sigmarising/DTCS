...
#define BUTTON_STYLESHEET(class_name,normal_color,normal_text_color,hover_color,hover_text_color,pressed_color,pressed_text_color)\
    (#class_name"{font: 18px Bauhaus 93;border-style:none;padding:10px;border-radius:5px;color:"#normal_text_color";background:"#normal_color";}"\
...
#define TXT_STYLESHEET(class_name,normal_color,focus_color)\
    (#class_name"{font:15px;border-style:none;padding:6px;border-radius:5px;border:2px solid "#normal_color";}"\
      #class_name":focus{border:2px solid "#focus_color";}")

#define TXTs_STYLESHEET(class_name,normal_color,focus_color)\
    (#class_name"{font:10px;border-style:none;padding:6px;border-radius:5px;border:2px solid "#normal_color";}"\
      #class_name":focus{border:2px solid "#focus_color";}")

#define BAR_STYLESHEET(class_name,normal_color,chunk_color)\
    (#class_name"{font:10px;height:8px;background:"#normal_color";border-radius:8px;text-align:center;border:1px solid "#normal_color";}"\
