...
//    m_bPressed = false;
    ...
    ui->quit->setStyleSheet("QPushButton{image: url(E:/DTCS-master2/DTCS-master/X2.png); background-color: rgb(255, 255, 255,0);\
            border-style:none;padding:10px;border-radius:19px;color:#FFFFFF}QPushButton:Hover{background-color: #EC7064;color:#FFF5E7;image: url(E:/DTCS-master2/DTCS-master/X2.png);}\
              QPushButton:Press{background-color:#DC2D1A;color: #F5A996};image: url(E:/DTCS-master2/DTCS-master/X2.png);");
    ui->PSD ->setStyleSheet(QString(TXT_STYLESHEET(QLineEdit,"#DCE4EC", "#3498DB")));
    ui->label_2->setStyleSheet("image:url(E:/DTCS-master/imgs/logoin2.png)");
