...
#define BUTTON_STYLESHEET(class_name,normal_color,normal_text_color,hover_color,hover_text_color,pressed_color,pressed_text_color)\
    (#class_name"{font: 15pt Bauhaus 93;border-style:none;padding:10px;border-radius:5px;color:"#normal_text_color";background:"#normal_color";}"\
...
#define BUTTON_STYLESHEET2(class_name,normal_color,normal_text_color,hover_color,hover_text_color,pressed_color,pressed_text_color)\
    (#class_name"{font: 8pt Bauhaus 93;border-style:none;padding:10px;border-radius:5px;color:"#normal_text_color";background:"#normal_color";}"\
    #class_name":hover{color:"#hover_text_color";background:"#hover_color";}"\
    #class_name":pressed{color:"#pressed_text_color";background:"#pressed_color";}")
...
#define BAR_STYLESHEET(class_name,normal_color,chunk_color)\
    (#class_name"{font:9pt;height:8px;background:"#normal_color";border-radius:8px;text-align:center;border:1px solid "#normal_color";}"\
